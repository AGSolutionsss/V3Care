...
const Booking = (props) => {
    ...
    useEffect(() => {
        fetch(baseURL+'/panel-fetch-referby-out')
    ...
    useEffect(() => {
        fetch(baseURL+'/panel-fetch-service-sub-out/'+booking.order_service)
        .then(response => response.json())
    ...
    const HalfA = (selectedValue) =>{
        ...
        axios({
            url: baseURL+"/panel-fetch-service-price-out",
            method: "POST",
            data,
        }).then((res) => {
    ...
    const HalfC = (selectedValue) =>{
        ...
        axios({
            url: baseURL+"/panel-fetch-services-prices-out",
            method: "POST",
            data,
        }).then((res) => {
            setBooking(booking => ({
    ...
    useEffect(() => {
        fetch(baseURL+'/panel-fetch-brancharea-out/'+booking.branch_id)
        .then(response => response.json())
    ...
    useEffect(() => {
        fetch(baseURL+'/panel-fetch-branchareakm-out/'+booking.branch_id+'/'+booking.order_area)
        .then(response => response.json())
        .then(data => {setAreaLat(data.areakm.area_lat);setAreaLng(data.areakm.area_lng);setAreaAddress(data.areakm.area_address)}); 
    }, [booking.branch_id,booking.order_area]);
    ...
    const handlePlaceSelect = async (updateQuery) => {
        ...
        updateQuery(query);
        console.log('check',addressObject);	
        ...
        var addressComponents = addressObject.address_components;
              ...
              console.log('dqdq',city.long_name);
        const latLng = {
    ...
    const onSubmit = (e) => {
        ...
        axios({
            url: baseURL+"/panel-create-booking-out",
            method: "POST",
            data,
