...
const Add = (props) => {
    ...
    const onSubmit = (e) => {
        ...
        axios({
            ...
            if(res.data.code == '200'){
                NotificationManager.success("Area Created Sucessfully");
  ...
  return (
    <div className="textfields-wrapper">
      <PageTitleBar title="Create Area" match={props.match} />
      <RctCollapsibleCard>
