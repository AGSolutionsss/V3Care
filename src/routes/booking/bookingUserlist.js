...
export default class BookingUserList extends React.Component {
  state = {
    loader: true,
    users: [],
    id:"",
            ...
            return (
              <div style={{ minWidth: "150px" , fontWeight: 800}}>
                <Tooltip title="Edit" placement="top">
                  ...
                  >
                    <Link to={"editBookingUser?id=" + value}>
                      <EditIcon />
                    </Link>
                  </IconButton>
                </Tooltip>
  ...
  getData = () => {
    ...
    this.setState({id:id});
    axios({
      url: baseURL+"/panel-fetch-booking-assign-list/"+id,
      method: "GET",
      headers: {
        ...
        {!loader && (
          <>
            ...
            <div className="donorbtns">
              <Link className="btn btn-outline-light" to={"addBookingUser?id=" + this.state.id}>
                <Button
