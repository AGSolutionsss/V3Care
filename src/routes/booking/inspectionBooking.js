...
export default class NewListInspectionBooking extends React.Component {
  state = {
    loader: true,
    users: [],
    bookingData: [],
            ...
            return (
              <div style={{ minWidth: "150px" , fontWeight: 800}}>
                <Tooltip title="Edit" placement="top"> 
                  ...
                  >
                    <Link to={"editInspection?id=" + value.substr(value.indexOf("#")+1, value.length-1)}>
                      <EditIcon />
                    </Link>
                  </IconButton>
                </Tooltip>
  ...
  getData = () => {
    let result = [];
    axios({
      url: baseURL+"/panel-fetch-booking-inspection-list",
      method: "GET",
      headers: {
      ...
      .then((res) => {
        ...
        for (let i = 0; i < response.length; i++) {
            ...
            tempRows.push([
                ...
                response[i]["order_inspection_status"],
