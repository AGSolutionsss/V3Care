...
const Postpone = (props) => {
    ...
    const onSubmit = (e) => {
        ...
        axios({
            url: baseURL+"/panel-update-booking-postpone/"+id,
            method: "PUT",
            data,
            headers: {
            Authorization: `Bearer ${localStorage.getItem("login")}`,
            ...
            if(res.data.code == '200'){
                NotificationManager.success("Booking Postpone Created Sucessfully");
  ...
  return (
    <div className="textfields-wrapper">
      <PageTitleBar title="Postpone Booking" match={props.match} />
      <RctCollapsibleCard>
