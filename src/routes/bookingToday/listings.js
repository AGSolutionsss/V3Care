...
export default class NewListTodayBooking extends React.Component {
  state = {
    loader: true,
    showmodal: false,
    bookingid: '',
  ...
  getData = () => {
    let result = [];
    axios({
      url: baseURL+"/panel-fetch-booking-today-list",
      method: "GET",
      headers: {
      ...
      .then((res) => {
      console.log("hsdjkfs", res.data.booking);
