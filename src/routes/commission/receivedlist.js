...
export default class CommissionReceivedList extends React.Component {
  state = {
    loader: true,
    users: [],
    id:"",
          ...
          customBodyRender: (value) => {
            return (
              <div style={{ minWidth: "150px" , fontWeight: 800}}>
                <Tooltip title="Update Commission Status to Not Received" placement="top">
                  <IconButton
                    aria-label="Update Commission Status to Not Received"
                    style={{
                      display:
  ...
  getData = () => {
    ...
    this.setState({id:id});
    axios({
      url: baseURL+"/panel-fetch-comm-received-list",
      method: "GET",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("login")}`,
      },
