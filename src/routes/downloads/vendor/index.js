...
if(v){
  setIsButtonDisabled(true)
    axios({
      url: baseURL+"/panel-download-vendor",
      method: "POST",
      data,
     headers: {
     ...
     link.click();
      NotificationManager.success("Vendor is Downloaded Successfully");
        setIsButtonDisabled(false)
      //history.push('listing');
    }).catch((err) =>{
     NotificationManager.error("Vendor is Not Downloaded");
     setIsButtonDisabled(false)
   });
  }
  };
  ...
  return (
    <div className="textfields-wrapper">
      <PageTitleBar title="Download Vendor" match={props.match} />
      <RctCollapsibleCard>
