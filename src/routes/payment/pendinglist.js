...
export default class PaymentPendingList extends React.Component {
  state = {
    loader: true,
    users: [],
    id:"",
          ...
          customBodyRender: (value) => {
            return (
              <div style={{ minWidth: "150px" , fontWeight: 800}}>
                ...
                {/* <Tooltip title="Update Payment Status to Received" placement="top">
                  <IconButton
                    aria-label="Update Payment Status to Received"
                    style={{
                      display:
  ...
  getData = () => {
    ...
    this.setState({id:id});
    axios({
      url: baseURL+"/panel-fetch-payment-pending-list",
      method: "GET",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("login")}`,
      },
